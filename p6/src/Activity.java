...
final public class Activity implements Action
{
    ...
    executeActivityAction(EventSchedule eventSchedule)
    {
 		...
 		else if(entity instanceof CookieMonster){
			CookieMonster cookie = (CookieMonster)entity;
                        cookie.executeActivity(world,eventSchedule);
		}


 		else if(entity instanceof Predator){
			Predator pred = (Predator)entity;
                        pred.executeActivity(world,eventSchedule);
		}
 		...
 		else if(entity instanceof Freeze){
			Freeze freeze = (Freeze)entity;
                        freeze.executeActivity(world,eventSchedule);
		}
